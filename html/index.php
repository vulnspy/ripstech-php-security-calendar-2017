...
<html lang="en">
 <head>
  <title>PHP Security Advent Calendar 2017</title>
  <meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width,initial-scale=1" />
  <link rel="canonical" href="https://www.ripstech.com/php-security-calendar-2017/" />
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:400,300,700" crossorigin="anonymous" />
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto+Condensed:400,300,700" crossorigin="anonymous" />
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat:700,400" crossorigin="anonymous" />
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/8.5.2/css/intlTelInput.css" integrity="sha384-q/KmkC+Ip91Dgg12kkN5vDQWq0mpuQQ7tM1uK3uA0jNxr9HjlsgaOOnhqxWUzVIE" crossorigin="anonymous" />
  <link rel="stylesheet" href="https://www.ripstech.com/dist/shariff.min.css??1534343765" />
  <link rel="stylesheet" href="https://www.ripstech.com/dist/rips.min.css??1534343765" />
  ...
  <link rel="manifest" href="https://www.ripstech.com//favicons/manifest.json" />
  ...
  <meta content="PHP Security Advent Calendar 2017" property="og:description" />
 </head>
 <body>
  <nav style="display:none;" class="navbar navbar-default navbar-fixed-top navbar-inverse navbar-pos-top">
   <div class="container">
    <div class="navbar-header">
     <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1"><span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span></button> 
     <a class="navbar-brand" href="/"><img src="https://www.ripstech.com/img/logo_type_light.svg" alt="RIPS" title="Back to Index" class="hidden-sm" /> <img src="https://www.ripstech.com/img/logo_light.svg" alt="RIPS" title="Back to Index" class="visible-sm" /></a>
    </div>
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
     <ul class="nav navbar-nav navbar-right">
      <li class=""><a href="https://www.ripstech.com/">Product</a></li>
      <li><a href="https://blog.ripstech.com/">Blog</a></li>
      <li class=""><a href="https://www.ripstech.com/php-security-analysis/">Insights</a></li>
      <li class=""><a href="https://www.ripstech.com/careers/">Careers</a></li>
      <li class=""><a href="https://www.ripstech.com/company/">Company</a></li>
      <li class=""><a class="highlight" href="https://www.ripstech.com/contact/message/">Contact</a></li>
      <li class=""><a class="highlight" href="https://www.ripstech.com/request-demo/">Request Demo</a></li>
     </ul>
    </div>
   </div>
  </nav>
  <div style="display:none;" class="clean-header">
  ...
  <div style="padding-top:5em;" class="apav">
   <div class="apav-background">
    <h3><strong>RIPS</strong>Tech presents | Migrated by <a style="color:#FFF;" href="https://www.vulnspy.com/"><strong>VULNSPY</strong> Lab </a> From <a href="https://www.ripstech.com/php-security-calendar-2017/">RIPSTECH.COM</a></h3>
    <h1>PHP Security Calendar 2017</h1>
    <div style="display:none;" class="newsletter text-center">
     <form method="POST" action="//ripstech.us14.list-manage.com/subscribe/post?u=d864b7e0607187e3917a94bc5&amp;id=d19d9ad04b" name="mc-embedded-subscribe-form" target="_blank" novalidate="">
      <div>
       <input type="email" class="form-control inputEmail" name="EMAIL" placeholder="E-Mail Address" /> 
       <input type="hidden" name="b_d864b7e0607187e3917a94bc5_d19d9ad04b" tabindex="-1" value="" />
      </div>
      <div>
       <button type="submit" name="subscribe" class="btn btn-lg btn-border btn-rips-white">Subscribe to our Newsletter</button>
      </div>
     </form>
    </div>
    <div class="cal">
   ...
   <div class="text-center about">
    <a href="http://blog.ripstech.com/2017/php-security-advent-calendar/" class="btn-rips-red"><i class="fa fa-fw fa-info-circle"></i> More about this calendar</a>
   </div>
   ...
   <div class="modal-dialog" role="document">
    <div class="modal-content">
     <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal"><span><img src="/images/close.png" /></span></button>
      ...
      <div class="highlight">
       <div class="chroma">
        <table class="lntable">
         <tbody>
          <tr>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="lnt"> 1</span><span class="lnt"> 2</span><span class="lnt"> 3</span><span class="lnt"> 4</span><span class="lnt"> 5</span><span class="lnt"> 6</span><span class="lnt"> 7</span><span class="lnt"> 8</span><span class="lnt"> 9</span><span class="lnt">10</span><span class="lnt">11</span><span class="lnt">12</span><span class="lnt">13</span><span class="lnt">14</span><span class="lnt">15</span><span class="lnt">16</span><span class="lnt">17</span><span class="lnt">18</span><span class="lnt">19</span><span class="lnt">20</span><span class="lnt">21</span></code></pre></td>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">Challenge</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="fm">__construct</span><span class="p">(</span><span class="nv">$file</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="fm">__destruct</span><span class="p">()</span> <span class="p">{</span>
...
<span class="nv">$challenge</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Challenge</span><span class="p">(</span><span class="nv">$_FILES</span><span class="p">[</span><span class="s1">'solution'</span><span class="p">]);</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-1-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-1-result">
       <div class="apav-result-box">
        <p>The challenge contains an arbitrary file upload vulnerability in line 13. The operation <code class="inline">in_array()</code> is used in line 12 to check if the file name is a number. However, it is type-unsafe because the third parameter is not set to 'true'. Hence, PHP will try to type-cast the file name to an integer value when comparing it to the array $whitelist (line 8). As a result it is possible to bypass the whitelist by prepending a value in the range of 1 and 24 to the file name, for example &quot;5backdoor.php&quot;. The uploaded PHP file then leads to code execution on the web server.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
      <div>
       <a href="https://www.ripstech.com/" class="btn btn-border btn-rips-green"><img src="/images/logo_light_small.png" /> &nbsp; Scan your code for vulnerabilities</a>
      </div>
     </div>
    </div>
   </div>
        ...
        <table class="lntable">
         <tbody>
          <tr>
           ...
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="c1">// composer require &quot;twig/twig&quot;
...
<span class="k">class</span> <span class="nc">Template</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="fm">__construct</span><span class="p">()</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">getNexSlideUrl</span><span class="p">()</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">render</span><span class="p">()</span> <span class="p">{</span>
...
<span class="p">(</span><span class="k">new</span> <span class="nx">Template</span><span class="p">())</span><span class="o">-&gt;</span><span class="na">render</span><span class="p">();</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-2-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-2-result">
       <div class="apav-result-box">
        <p>The challenge contains a cross-site scripting vulnerability in line 26. There are two filters that try to assure that the link that is passed to the <code class="inline">&lt;a&gt;</code> tag is a genuine URL. First, the <code class="inline">filter_var()</code> function in line 22 checks if it is a valid URL. Then, Twig's template escaping is used in line 10 that avoids breaking out of the <code class="inline">href</code> attribute.</p>
        <p>The vulnerability can still be exploited with the following URL: <code class="inline">?nextSlide=javascript://comment%250aalert(1)</code>.<br />The payload does not involve any markup characters that would be affected by Twig's escaping. At the same time, it is a valid URL for <code class="inline">filter_var()</code>. We used a JavaScript protocol handler, followed by a JavaScript comment introduced with <code class="inline">//</code> and then the actual JS payload follows on a newline. When the link is clicked, the JavaScript payload is executed in the browser of the victim.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
        ...
        <table class="lntable">
         <tbody>
          <tr>
           ...
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">function</span> <span class="o"></span><span class="nf">__autoload</span><span class="p">(</span><span class="nv">$className</span><span class="p">)</span> <span class="p">{</span>
...
<span class="k">class</span> <span class="nc">HomeController</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="fm">__construct</span><span class="p">(</span><span class="nv">$template</span><span class="p">,</span> <span class="nv">$variables</span><span class="p">)</span> <span class="p">{</span>
...
<span class="p">}</span></code></pre></td>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-3-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-3-result">
       <div class="apav-result-box">
        <p>In this code are two security bugs. A file inclusion vulnerability is triggered by the call of <code class="inline">class_exists()</code> in line 8. Here, the existance of a user supplied class name is checked. This automatically invokes the custom autoloader in line 1 in case the class name is unknown which will try to include unknown classes. An attacker can abuse this file inclusion by using a path traversal attack. The lookup for the class name <code class="inline">../../../../etc/passwd</code> will leak the passwd file. The attack only works until version 5.3 of PHP.<br />But there is a second bug that also works in recent PHP versions. In line 9, the class name is used for a new object instantiation. The first argument of its constructor is under the attackers control as well. Arbitrary constructors of the PHP code base can be called. Even if the code itself does not contain a vulnerable constructor, PHP's built-in class <code class="inline">SimpleXMLElement</code> can be used for an XXE attack that also leads to the exposure of files. A real world example of this exploit can be found in our <a href="https://blog.ripstech.com/2017/shopware-php-object-instantiation-to-blind-xxe/">blog post</a>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
  ...
  <div class="modal fade modal-apav" tabindex="-1" role="dialog" id="modal-day-4">
   <div class="modal-dialog" role="document">
       ...
       <div class="chroma">
        <table class="lntable">
         <tbody>
          <tr>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="lnt"> 1</span><span class="lnt"> 2</span><span class="lnt"> 3</span><span class="lnt"> 4</span><span class="lnt"> 5</span><span class="lnt"> 6</span><span class="lnt"> 7</span><span class="lnt"> 8</span><span class="lnt"> 9</span><span class="lnt">10</span><span class="lnt">11</span><span class="lnt">12</span><span class="lnt">13</span><span class="lnt">14</span><span class="lnt">15</span><span class="lnt">16</span><span class="lnt">17</span><span class="lnt">18</span><span class="lnt">19</span><span class="lnt">20</span><span class="lnt">21</span></code></pre></td>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">Login</span> <span class="p">{</span>
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="fm">__construct</span><span class="p">(</span><span class="nv">$user</span><span class="p">,</span> <span class="nv">$pass</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">loginViaXml</span><span class="p">(</span><span class="nv">$user</span><span class="p">,</span> <span class="nv">$pass</span><span class="p">)</span> <span class="p">{</span>
...
<span class="k">new</span> <span class="nx">Login</span><span class="p">(</span><span class="nv">$_POST</span><span class="p">[</span><span class="s1">'username'</span><span class="p">],</span> <span class="nv">$_POST</span><span class="p">[</span><span class="s1">'password'</span><span class="p">]);</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-4-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-4-result">
       <div class="apav-result-box">
        <p>This challenge suffers from an XML injection vulnerability in line 14. An attacker can manipulate the XML structure and hence bypass the authentication. There is an attempt to prevent exploitation in lines 8 and 9 by searching for angle brackets but the check can be bypassed with a specifically crafted payload. The bug in this code is the automatic casting of variables in PHP. The PHP built-in function <code class="inline">strpos()</code> returns the numeric position of the looked up character. This can be <code class="inline">0</code> if the first character is the one searched for. The 0 is then type-casted to a boolean <code class="inline">false</code> for the <code class="inline">if</code> comparison which renders the overall constraint to true. A possible payload could look like <code class="inline">user=&lt;&quot;&gt;&lt;injected-tag%20property=&quot;&amp;pass=&lt;injected-tag&gt;</code>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
  ...
  <div class="modal fade modal-apav" tabindex="-1" role="dialog" id="modal-day-5">
   <div class="modal-dialog" role="document">
        ...
        <table class="lntable">
         <tbody>
          <tr>
           ...
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">Mailer</span> <span class="p">{</span>
    <span class="k">private</span> <span class="k">function</span> <span class="o"></span><span class="nf">sanitize</span><span class="p">(</span><span class="nv">$email</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">send</span><span class="p">(</span><span class="nv">$data</span><span class="p">)</span> <span class="p">{</span>
...
<span class="nv">$mailer</span><span class="o">-&gt;</span><span class="na">send</span><span class="p">(</span><span class="nv">$_POST</span><span class="p">);</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-5-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-5-result">
       <div class="apav-result-box">
        <p>This challenge suffers from a command execution vulnerability in line 31. The fifth parameter of mail, in this case the variable <code class="inline">$_POST['from']</code>, is appended to the sendmail command that is executed to send out the email. It is not possible to execute arbitrary commands here but it is possible to append arbitrary new parameters to sendmail. This can be abused to create a PHP backdoor in the web directory through the log files of sendmail.<br />There are 2 insufficient protections in place that try to prevent successful exploitation. The method <code class="inline">sanitize()</code> first checks in line 3 if the e-mail address is valid. However, not all characters that are necessary to exploit the security issue in <code class="inline">mail()</code> are forbidden by this filter. It allows the usage of escaped whitespaces nested in double quotes. In line 7 the e-mail address gets sanitized with <code class="inline">escapeshellarg()</code>. This would be sufficient if PHP would not escape the fifth parameter internally with <code class="inline">escapeshellcmd()</code>. Since it does escape the parameter again, the <code class="inline">escapeshellcmd()</code> allows an attacker to break out of the <code class="inline">escapeshellarg()</code>. More information, details, and a PoC can be found in our blog post <a href="https://blog.ripstech.com/2017/why-mail-is-dangerous-in-php/">“Why mail() is dangerous in PHP”</a>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
  ...
  <div class="modal fade modal-apav" tabindex="-1" role="dialog" id="modal-day-6">
   <div class="modal-dialog" role="document">
        ...
        <table class="lntable">
         <tbody>
          <tr>
           ...
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">TokenStorage</span> <span class="p">{</span>
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">performAction</span><span class="p">(</span><span class="nv">$action</span><span class="p">,</span> <span class="nv">$data</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">createToken</span><span class="p">(</span><span class="nv">$seed</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">clearToken</span><span class="p">(</span><span class="nv">$token</span><span class="p">)</span> <span class="p">{</span>
...
<span class="nv">$storage</span><span class="o">-&gt;</span><span class="na">performAction</span><span class="p">(</span><span class="nv">$_GET</span><span class="p">[</span><span class="s1">'action'</span><span class="p">],</span> <span class="nv">$_GET</span><span class="p">[</span><span class="s1">'data'</span><span class="p">]);</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-6-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-6-result">
       <div class="apav-result-box">
        <p>This challenge contains a file delete vulnerability. The bug causing this issue is a non-escaped hyphen character (<code class="inline">-</code>) in the regular expression that is used in the <code class="inline">preg_replace()</code> call in line 21. If the hyphen is not escaped, it is used as a range indicator, leading to a replacement of any character that is not a-z or an ASCII character in the range between dot (<code class="inline">46</code>) and underscore (<code class="inline">95</code>). Thus dot and slash can be used for directory traversal and (almost) arbitrary files can be deleted, for example with the query parameters <code class="inline">action=delete&amp;data=../../config.php</code>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
        ...
        <table class="lntable">
         <tbody>
          <tr>
           ...
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">function</span> <span class="o"></span><span class="nf">getUser</span><span class="p">(</span><span class="nv">$id</span><span class="p">)</span> <span class="p">{</span>
...
<span class="k">echo</span> <span class="s1">'&lt;h1&gt;'</span><span class="o">.</span><span class="nx">htmlspecialchars</span><span class="p">(</span><span class="nv">$currentUser</span><span class="p">)</span><span class="o">.</span><span class="s1">'&lt;/h1&gt;'</span><span class="p">;</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-7-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-7-result">
       <div class="apav-result-box">
        <p>This challenge suffers from a connection string injection vulnerability in line 4. It occurs because of the <code class="inline">parse_str()</code> call in line 21 that behaves very similar to register globals. Query parameters from the referrer are extracted to variables in the current scope, thus we can control the global variable <code class="inline">$config</code> inside of <code class="inline">getUser()</code> in lines 5 to 8. To exploit this vulnerability we can connect to our own MySQL server and return arbitrary values for username, for example with the referrer <code class="inline">http://host/?config[dbhost]=10.0.0.5&amp;config[dbuser]=root&amp;config[dbpass]=root&amp;config[dbname]=malicious&amp;id=1</code>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
       ...
       <div class="chroma">
        <table class="lntable">
         <tbody>
          <tr>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="lnt"> 1</span><span class="lnt"> 2</span><span class="lnt"> 3</span><span class="lnt"> 4</span><span class="lnt"> 5</span><span class="lnt"> 6</span><span class="lnt"> 7</span><span class="lnt"> 8</span><span class="lnt"> 9</span><span class="lnt">10</span><span class="lnt">11</span><span class="lnt">12</span><span class="lnt">13</span></code></pre></td>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="nx">header</span><span class="p">(</span><span class="s2">&quot;Content-Type: text/plain&quot;</span><span class="p">);</span>

<span class="k">function</span> <span class="o"></span><span class="nf">complexStrtolower</span><span class="p">(</span><span class="nv">$regex</span><span class="p">,</span> <span class="nv">$value</span><span class="p">)</span> <span class="p">{</span>
...
<span class="p">}</span></code></pre></td>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-8-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-8-result">
       <div class="apav-result-box">
        <p>This challenge contains a code injection vulnerability in line 4. Prior to PHP 7 the operation <code class="inline">preg_replace()</code> contained an eval modifier, short <code class="inline">e</code>. If the modifier is set, the second parameter (replacement) is treated as PHP code. We do not have a direct injection point into the second parameter but we can control the value of <code class="inline">\\1</code>, as it references the matched regular expression. It is not possible to escape out of the <code class="inline">strtolower()</code> call but since the referenced value is inside of double quotes, we can use PHP’s curly syntax to inject other function calls. An attack could look like this: <code class="inline">/?.*={${phpinfo()}}</code>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
        ...
        <table class="lntable">
         <tbody>
          <tr>
           ...
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">LanguageManager</span>
<span class="p">{</span>
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">loadLanguage</span><span class="p">()</span>
    <span class="p">{</span>
    ...
    <span class="k">private</span> <span class="k">function</span> <span class="o"></span><span class="nf">getBrowserLanguage</span><span class="p">()</span>
    <span class="p">{</span>
    ...
    <span class="k">private</span> <span class="k">function</span> <span class="o"></span><span class="nf">sanitizeLanguage</span><span class="p">(</span><span class="nv">$language</span><span class="p">)</span>
    <span class="p">{</span>
...
<span class="p">(</span><span class="k">new</span> <span class="nx">LanguageManager</span><span class="p">())</span><span class="o">-&gt;</span><span class="na">loadLanguage</span><span class="p">();</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-9-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-9-result">
       <div class="apav-result-box">
        <p>This challenge contains a file inclusion vulnerability that can allow an attacker to execute arbitrary code on the server or to leak sensitive files. The bug is in the sanitization function in line 18. The replacement of the <code class="inline">../</code> string is not executed recursively. This allows the attacker to simply use the character sequence <code class="inline">....//</code> or <code class="inline">..././</code> that after replacement will end in <code class="inline">../</code> again. Thus, changing the path to the included language file via path traversal is possible. For example, the system's passwd file can be leaked by setting the following payload in the Accept-Language HTTP request header: <code class="inline">.//....//....//etc/passwd</code>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
        ...
        <table class="lntable">
         <tbody>
          <tr>
           ...
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="nx">extract</span><span class="p">(</span><span class="nv">$_POST</span><span class="p">);</span>

<span class="k">function</span> <span class="o"></span><span class="nf">goAway</span><span class="p">()</span> <span class="p">{</span>
...
<span class="p">}</span></code></pre></td>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-10-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-10-result">
       <div class="apav-result-box">
        <p>This challenge contains a code injection vulnerability in line 12 that can be used by an attacker to execute arbitrary PHP code on the web server. The operation <code class="inline">assert()</code> evaluates PHP code and it contains user input. In line 1, all POST parameters are instantiated as global variables by PHP's built-in function <code class="inline">extract()</code>. This can lead to severe problems itself but in this challenge it is only used for a variety of sources. It enables the attacker to set the <code class="inline">$pi</code> variable directly via POST Parameter. In line 8 there is a check to verify if the input is numeric and if not the user is redirected to an error page via the <code class="inline">goAway()</code> function. However, after the redirect in line 5 the PHP script continues running because there is no <code class="inline">exit()</code> call. Thus, user provided PHP code in the <code class="inline">pi</code> parameter is always executed, e.g. <code class="inline">pi=phpinfo()</code>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
  ...
  <div class="modal fade modal-apav" tabindex="-1" role="dialog" id="modal-day-11">
   <div class="modal-dialog" role="document">
        ...
        <table class="lntable">
         <tbody>
          <tr>
           ...
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">Template</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="fm">__construct</span><span class="p">(</span><span class="nv">$data</span> <span class="o">=</span> <span class="k">null</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">loadData</span><span class="p">(</span><span class="nv">$data</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">createCache</span><span class="p">(</span><span class="nv">$file</span> <span class="o">=</span> <span class="k">null</span><span class="p">,</span> <span class="nv">$tpl</span> <span class="o">=</span> <span class="k">null</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">render</span><span class="p">(</span><span class="nv">$data</span><span class="p">)</span> <span class="p">{</span>
...
<span class="k">new</span> <span class="nx">Template</span><span class="p">(</span><span class="nv">$_COOKIE</span><span class="p">[</span><span class="s1">'data'</span><span class="p">]);</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-11-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-11-result">
       <div class="apav-result-box">
        <p>This challenge contains an PHP object injection vulnerability. In line 13 an attacker is able to pass user input into the <code class="inline">unserialize()</code> function by altering his cookie <em>data</em>. There are two checks in line 11 and 12 that try to prevent the deserialization of objects. The first check can be easily circumvented, for example by injecting an object into an array, leading to a payload string beginning with <code class="inline">a:1:</code> instead of <code class="inline">O:</code>. The second check can be bypassed by abusing PHP's flexible serialization syntax. It is possible to use the syntax <code class="inline">O:+1:</code> to bypass this regex. Finally, this means an attacker can inject an object of class <code class="inline">Template</code> into the application. After the serialized form is deserialized and the Template object is instantiated, its destructor is called when the script terminates (line 31). Now, the attacker controlled properties <code class="inline">cacheFile</code> and <code class="inline">template</code> of the injected object are used to write to a file in line 21. Thus, the attacker can create arbitraries files on the file system, for example a PHP shell in the document root: <code class="inline">a:1:{i:0;O:%2b8:&quot;Template&quot;:2:{s:9:&quot;cacheFile&quot;;s:14:&quot;/var/www/a.php&quot;;s:8:&quot;template&quot;;s:16:&quot;&lt;?php%20phpinfo();&quot;;}}</code> More information about this attack can be found <a href="https://blog.ripstech.com/tags/php-object-injection/" target="_blank">in our blog posts</a>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
        ...
        <table class="lntable">
         <tbody>
          <tr>
           ...
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="nv">$sanitized</span> <span class="o">=</span> <span class="p">[];</span>
...
<span class="k">echo</span> <span class="s2">&quot;&lt;a href='/images/size.php?&quot;</span> <span class="o">.</span>
    <span class="nx">htmlentities</span><span class="p">(</span><span class="nv">$query</span><span class="p">)</span> <span class="o">.</span> <span class="s2">&quot;'&gt;link&lt;/a&gt;&quot;</span><span class="p">;</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-12-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-12-result">
       <div class="apav-result-box">
        <p>There is a cross-site scripting vulnerability in line 13. This bug depends on the fact that the keys of the <code class="inline">$_GET</code> array (the GET parameter names) are not sufficiently sanitized in the code. Both the keys and the sanitized GET values are passed to the <code class="inline">href</code> attribute of the <code class="inline">&lt;a&gt;</code> tag as a concatenated string. The sanitizer <code class="inline">htmlentities()</code> is used, however, single quotes are not affected by default by this built-in function. Hence, an attacker is able to perform an XSS attack against the user, for example using the following query parameter that breaks the <code class="inline">href</code> attribute and appends an eventhandler with JavaScript code: <code class="inline">/?a'onclick%3dalert(1)%2f%2f=c</code>. Note that the payload is within the parameter name, not the parameter value.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
  ...
  <div class="modal fade modal-apav" tabindex="-1" role="dialog" id="modal-day-13">
   <div class="modal-dialog" role="document">
       ...
       <div class="chroma">
        <table class="lntable">
         <tbody>
          <tr>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="lnt"> 1</span><span class="lnt"> 2</span><span class="lnt"> 3</span><span class="lnt"> 4</span><span class="lnt"> 5</span><span class="lnt"> 6</span><span class="lnt"> 7</span><span class="lnt"> 8</span><span class="lnt"> 9</span><span class="lnt">10</span><span class="lnt">11</span><span class="lnt">12</span><span class="lnt">13</span><span class="lnt">14</span><span class="lnt">15</span><span class="lnt">16</span><span class="lnt">17</span><span class="lnt">18</span><span class="lnt">19</span><span class="lnt">20</span><span class="lnt">21</span><span class="lnt">22</span><span class="lnt">23</span><span class="lnt">24</span><span class="lnt">25</span><span class="lnt">26</span><span class="lnt">27</span><span class="lnt">28</span><span class="lnt">29</span><span class="lnt">30</span><span class="lnt">31</span><span class="lnt">32</span><span class="lnt">33</span><span class="lnt">34</span><span class="lnt">35</span><span class="lnt">36</span></code></pre></td>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">LoginManager</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="fm">__construct</span><span class="p">(</span><span class="nv">$user</span><span class="p">,</span> <span class="nv">$password</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">isValid</span><span class="p">()</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">sanitizeInput</span><span class="p">(</span><span class="nv">$input</span><span class="p">,</span> <span class="nv">$length</span> <span class="o">=</span> <span class="mi">20</span><span class="p">)</span> <span class="p">{</span>
...
<span class="p">}</span></code></pre></td>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-13-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-13-result">
       <div class="apav-result-box">
        <p>Today's challenge contains a DQL (Doctrine Query Language) injection vulnerability in line 19. A DQL injection is similar to a SQL injection but more limited, nonetheless the <code class="inline">where()</code> method of Doctrine is vulnerable. In line 13 and 14 sanitization is added to the input, however, the <code class="inline">sanitizeInput()</code> method has a bug. First, it uses <code class="inline">addslashes()</code> for escaping relevant characters by adding a backslash \ infront of them. In this case if we pass a \ as input, it get escaped to \\. But then, the <code class="inline">substr()</code> function is used to truncate the escaped string. This enables an attacker to send a string that is long enough that the escaped backslash is cut off and we are left with a single \ at the end of the string. This will then break the WHERE statement and allows the injection of own DQL syntax, for example the condition <code class="inline">OR 1=1</code> that is always true and bypasses the authentication: <code class="inline">user=1234567890123456789\&amp;passwd=%20OR%201=1-</code>. The resulting WHERE statement will look like <code class="inline">user = '1234567890123456789\' AND password = ' OR 1=1-'</code> in DQL. Note how the backslash confuses the quotes and allows to inject DQL into the password value. The resulting query does not look valid because of the trailing slash. Fortunately, Doctrine closes the last single quote on its own, so the resulting query looks like <code class="inline">OR 1=1-''</code>.<br />To avoid DQL injections always use bound parameters for dynamic conditions. Never try to secure a DQL query with <code class="inline">addslashes()</code> or similar functions. Additionally, the password should be stored hashed in the database, for example in the BCrypt format.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
  ...
  <div class="modal fade modal-apav" tabindex="-1" role="dialog" id="modal-day-14">
   <div class="modal-dialog" role="document">
       ...
       <div class="chroma">
        <table class="lntable">
         <tbody>
          <tr>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="lnt"> 1</span><span class="lnt"> 2</span><span class="lnt"> 3</span><span class="lnt"> 4</span><span class="lnt"> 5</span><span class="lnt"> 6</span><span class="lnt"> 7</span><span class="lnt"> 8</span><span class="lnt"> 9</span><span class="lnt">10</span><span class="lnt">11</span><span class="lnt">12</span><span class="lnt">13</span><span class="lnt">14</span><span class="lnt">15</span><span class="lnt">16</span><span class="lnt">17</span><span class="lnt">18</span><span class="lnt">19</span><span class="lnt">20</span><span class="lnt">21</span><span class="lnt">22</span><span class="lnt">23</span></code></pre></td>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">Carrot</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="fm">__construct</span><span class="p">(</span><span class="nv">$input</span><span class="p">)</span> <span class="p">{</span>
...
<span class="nv">$carrot</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Carrot</span><span class="p">(</span><span class="nv">$_GET</span><span class="p">);</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-14-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-14-result">
       <div class="apav-result-box">
        <p>This class is vulnerable to directory traversal because of mass assignment. The constructor can be used to set arbitrary class attributes (line 11). By overwriting the attribute <code class="inline">$id</code> you gain control over the first parameter of <code class="inline">file_put_contents()</code> in line 16. With the help of <code class="inline">../</code> it is possible to target arbitrary files on the system that are writable, for example it can be used to create a PHP shell in the document root. The values that are send to the class are incremented in line 11 and thus an integer after the operation is done. The incrementation happens after the assignment though, so the class attribute contains the original value of <code class="inline">$count</code>.<br />To avoid this security issue be vary careful when using reflection based on user input to set variables. It is recommended to implement a white-list verfication that contains the names of all variables that can be modified. A real world example of a vulnerability that is caused by mass assignment can be found <a href="https://blog.ripstech.com/2016/the-state-of-wordpress-security/#podlove-publisher" target="_blank">in our blog</a>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
  ...
  <div class="modal fade modal-apav" tabindex="-1" role="dialog" id="modal-day-15">
   <div class="modal-dialog" role="document">
       ...
       <div class="chroma">
        <table class="lntable">
         <tbody>
          <tr>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="lnt"> 1</span><span class="lnt"> 2</span><span class="lnt"> 3</span><span class="lnt"> 4</span><span class="lnt"> 5</span><span class="lnt"> 6</span><span class="lnt"> 7</span><span class="lnt"> 8</span><span class="lnt"> 9</span><span class="lnt">10</span><span class="lnt">11</span><span class="lnt">12</span><span class="lnt">13</span><span class="lnt">14</span><span class="lnt">15</span><span class="lnt">16</span><span class="lnt">17</span><span class="lnt">18</span><span class="lnt">19</span><span class="lnt">20</span><span class="lnt">21</span><span class="lnt">22</span><span class="lnt">23</span></code></pre></td>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">Redirect</span> <span class="p">{</span>
    ...
    <span class="k">private</span> <span class="k">function</span> <span class="o"></span><span class="nf">setHeaders</span><span class="p">(</span><span class="nv">$url</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">startRedirect</span><span class="p">(</span><span class="nv">$params</span><span class="p">)</span> <span class="p">{</span>
...
<span class="p">}</span></code></pre></td>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-15-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-15-result">
       <div class="apav-result-box">
        <p>This challenge contains an open redirect vulnerability in line 6. The code takes the input from the super global <code class="inline">$_SERVER[‘PHP_SELF’]</code> and splits it at the slash character (line 10). Then the last part is taken and used to build the new URL that is passed into the <code class="inline">header()</code> function. An attacker is able to inject his own URL by using url-encoded characters that are decoded in line 5. A possible payload could look like <code class="inline">/index.php/http:%252f%252fwww.domain.com?redirect=1</code>.<br />This bug allows an attacker to redirect the user from the original site to a site of the attackers will. The attacker then could do phishing, for example he could present a forged login screen to grab the credentials of the user for the original site.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
  ...
  <div class="modal fade modal-apav" tabindex="-1" role="dialog" id="modal-day-16">
   <div class="modal-dialog" role="document">
        ...
        <table class="lntable">
         <tbody>
          <tr>
           ...
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">FTP</span> <span class="p">{</span>
    <span class="k">public</span> <span class="nv">$sock</span><span class="p">;</span>

    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="fm">__construct</span><span class="p">(</span><span class="nv">$host</span><span class="p">,</span> <span class="nv">$port</span><span class="p">,</span> <span class="nv">$user</span><span class="p">,</span> <span class="nv">$pass</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">private</span> <span class="k">function</span> <span class="o"></span><span class="nf">cleanInput</span><span class="p">()</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">login</span><span class="p">(</span><span class="nv">$username</span><span class="p">,</span> <span class="nv">$password</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">mode</span><span class="p">(</span><span class="nv">$mode</span><span class="p">)</span> <span class="p">{</span>
...
<span class="k">new</span> <span class="nx">FTP</span><span class="p">(</span><span class="s1">'localhost'</span><span class="p">,</span> <span class="mi">21</span><span class="p">,</span> <span class="s1">'user'</span><span class="p">,</span> <span class="s1">'password'</span><span class="p">);</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-16-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-16-result">
       <div class="apav-result-box">
        <p>This challenge contains two bugs that can be used together to inject data into the open FTP connection. The first bug is the usage of <code class="inline">$_REQUEST</code> in line 9 while only sanitizing <code class="inline">$_GET</code> and <code class="inline">$_POST</code> in lines 14 to 16. <code class="inline">$_REQUEST</code> is the combination of <code class="inline">$_GET</code>, <code class="inline">$_POST</code>, and <code class="inline">$_COOKIE</code> but it is only a copy of the values, not a reference. Therefore the sanitization of <code class="inline">$_GET</code>, <code class="inline">$_POST</code>, and <code class="inline">$_COOKIE</code> alone is not sufficient. A real world example of a vulnerability that is caused by a similar confusion can be found <a href="https://blog.ripstech.com/2016/the-state-of-wordpress-security/#all-in-one-wp-security-firewall" target="_blank">in our blog</a>.<br /><br />The second bug is the usage of the type-unsafe comparison <code class="inline">==</code> instead of <code class="inline">===</code> in line 25. This enables an attacker to inject and execute new commands in the existing connection, for example a delete command with the query string <code class="inline">?mode=1%0a%0dDELETE%20test.file</code>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
  ...
  <div class="modal fade modal-apav" tabindex="-1" role="dialog" id="modal-day-17">
   <div class="modal-dialog" role="document">
       ...
       <div class="chroma">
        <table class="lntable">
         <tbody>
          <tr>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="lnt"> 1</span><span class="lnt"> 2</span><span class="lnt"> 3</span><span class="lnt"> 4</span><span class="lnt"> 5</span><span class="lnt"> 6</span><span class="lnt"> 7</span><span class="lnt"> 8</span><span class="lnt"> 9</span><span class="lnt">10</span><span class="lnt">11</span><span class="lnt">12</span><span class="lnt">13</span><span class="lnt">14</span><span class="lnt">15</span><span class="lnt">16</span><span class="lnt">17</span><span class="lnt">18</span><span class="lnt">19</span><span class="lnt">20</span><span class="lnt">21</span><span class="lnt">22</span><span class="lnt">23</span><span class="lnt">24</span><span class="lnt">25</span><span class="lnt">26</span><span class="lnt">27</span><span class="lnt">28</span><span class="lnt">29</span><span class="lnt">30</span><span class="lnt">31</span><span class="lnt">32</span><span class="lnt">33</span><span class="lnt">34</span><span class="lnt">35</span></code></pre></td>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">RealSecureLoginManager</span> <span class="p">{</span>
    <span class="k">private</span> <span class="nv">$em</span><span class="p">;</span>
    <span class="k">private</span> <span class="nv">$user</span><span class="p">;</span>
    <span class="k">private</span> <span class="nv">$password</span><span class="p">;</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">sanitizeInput</span><span class="p">(</span><span class="nv">$input</span><span class="p">)</span> <span class="p">{</span>
...
<span class="p">}</span></code></pre></td>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-17-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-17-result">
       <div class="apav-result-box">
        <p>This challenge is supposed to be a fixed version of day 13 but it introduces new vulnerabilities instead. The author tried to fix the DQL injection by applying <code class="inline">addslashes()</code> without <code class="inline">substr()</code> on the user name, and by hashing the password in line 13 using <code class="inline">md5()</code>. Besides the fact that md5 should not be used to hash passwords and that password hashes should not be compared this way, the second parameter is set to true. This returns the hash in binary format. The binary hash can contain ASCII characters that are interpreted by Doctrine. In this case an attacker could use the value <code class="inline">128</code> as the password, resulting in <code class="inline">v�an���l���q��\</code> as hash. With the backslash at the end the single quote gets escaped leading to an injection. A possible payload could be <code class="inline">?user=%20OR%201=1-&amp;passwd=128</code>.<br />To avoid DQL injections always use bound parameters for dynamic conditions. Never try to secure a DQL query with <code class="inline">addslashes()</code> or similar functions. Additionally, the password should be stored in a secure hashing format, for example BCrypt.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
      ...
      <div class="highlight">
       <div class="chroma">
        <table class="lntable">
         <tbody>
          <tr>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="lnt"> 1</span><span class="lnt"> 2</span><span class="lnt"> 3</span><span class="lnt"> 4</span><span class="lnt"> 5</span><span class="lnt"> 6</span><span class="lnt"> 7</span><span class="lnt"> 8</span><span class="lnt"> 9</span><span class="lnt">10</span><span class="lnt">11</span><span class="lnt">12</span></code></pre></td>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">JWT</span> <span class="p">{</span>
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">verifyToken</span><span class="p">(</span><span class="nv">$data</span><span class="p">,</span> <span class="nv">$signature</span><span class="p">)</span> <span class="p">{</span>
...
<span class="p">(</span><span class="k">new</span> <span class="nx">JWT</span><span class="p">())</span><span class="o">-&gt;</span><span class="na">verifyToken</span><span class="p">(</span><span class="nv">$_GET</span><span class="p">[</span><span class="s1">'d'</span><span class="p">],</span> <span class="nv">$_GET</span><span class="p">[</span><span class="s1">'s'</span><span class="p">]);</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-18-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-18-result">
       <div class="apav-result-box">
        <p>This challenge contains a bug in the usage of the <code class="inline">openssl_verify()</code> function in line 5 that leads to an authentication bypass in line 7. The function has three return values: <code class="inline">1</code> if the signature is correct, <code class="inline">0</code> if the signature verification failed, and <code class="inline">-1</code> if there was an error while performing the verification. So if an attacker generates a valid signature for the data using another algorithm than the one <code class="inline">pub_key.pem</code> is using, the <code class="inline">openssl_verify()</code> function returns <code class="inline">-1</code> which is casted to <code class="inline">true</code> automatically. To avoid this problem use the type-safe comparison <code class="inline">===</code> to validate the return value of <code class="inline">openssl_verify()</code>, or consider using a different <a href="https://paragonie.com/blog/2015/11/choosing-right-cryptography-library-for-your-php-project-guide" target="_blank">library for cryptography</a>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
  ...
  <div class="modal fade modal-apav" tabindex="-1" role="dialog" id="modal-day-19">
   <div class="modal-dialog" role="document">
       ...
       <div class="chroma">
        <table class="lntable">
         <tbody>
          <tr>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="lnt"> 1</span><span class="lnt"> 2</span><span class="lnt"> 3</span><span class="lnt"> 4</span><span class="lnt"> 5</span><span class="lnt"> 6</span><span class="lnt"> 7</span><span class="lnt"> 8</span><span class="lnt"> 9</span><span class="lnt">10</span><span class="lnt">11</span><span class="lnt">12</span><span class="lnt">13</span><span class="lnt">14</span><span class="lnt">15</span><span class="lnt">16</span><span class="lnt">17</span><span class="lnt">18</span><span class="lnt">19</span><span class="lnt">20</span><span class="lnt">21</span><span class="lnt">22</span><span class="lnt">23</span><span class="lnt">24</span><span class="lnt">25</span><span class="lnt">26</span><span class="lnt">27</span></code></pre></td>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">ImageViewer</span> <span class="p">{</span>
    <span class="k">private</span> <span class="nv">$file</span><span class="p">;</span>

    <span class="k">function</span> <span class="o"></span><span class="fm">__construct</span><span class="p">(</span><span class="nv">$file</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">function</span> <span class="o"></span><span class="nf">createThumbnail</span><span class="p">()</span> <span class="p">{</span>
        <span class="nv">$e</span> <span class="o">=</span> <span class="nx">stripcslashes</span><span class="p">(</span>
            ...
            <span class="p">)</span>
        <span class="p">);</span>
        <span class="nx">system</span><span class="p">(</span><span class="s2">&quot;/usr/bin/convert </span><span class="si">{</span><span class="x">$this-&gt;file</span><span class="si">}</span><span class="s2"> --resize </span><span class="si">$e</span><span class="s2">
</span><span class="s2">                ./thumbs/</span><span class="si">{</span><span class="x">$this-&gt;file</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">);</span>
    <span class="p">}</span>

    <span class="k">function</span> <span class="o"></span><span class="fm">__toString</span><span class="p">()</span> <span class="p">{</span>
        <span class="k">return</span> <span class="s2">&quot;&lt;a href=</span><span class="si">{</span><span class="x">$this-&gt;file</span><span class="si">}</span><span class="s2">&gt;
</span><span class="s2">                &lt;img src=./thumbs/</span><span class="si">{</span><span class="x">$this-&gt;file</span><span class="si">}</span><span class="s2">&gt;&lt;/a&gt;&quot;</span><span class="p">;</span>
    <span class="p">}</span>
<span class="p">}</span>

<span class="k">echo</span> <span class="p">(</span><span class="k">new</span> <span class="nx">ImageViewer</span><span class="p">(</span><span class="s2">&quot;image.png&quot;</span><span class="p">));</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-19-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-19-result">
       <div class="apav-result-box">
        <p>The <code class="inline">ImageViewer</code> class is prone to remote command execution through the <code class="inline">size</code> parameter in line 17. The <code class="inline">preg_replace()</code> call will purge almost any non-digit characters. This is not sufficient though because the function <code class="inline">stripcslashes()</code> will not only strip slashes but it will also replace C literal escape sequences with their actual byte representation. The backslash character is untouched by the <code class="inline">preg_replace()</code> call allowing an attacker to inject an octal byte escape sequence similar to <code class="inline">0\073\163\154\145\145\160\0405\073</code>. The <code class="inline">stripcslashes()</code> function will evaluate this input to <code class="inline">0;sleep 5;</code> which is concatenated into the system command and finally executed in the attackers favor.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
...
<span class="p">{</span>
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">getResult</span><span class="p">(</span><span class="nv">$uri</span><span class="p">)</span>
    <span class="p">{</span>
...
<span class="k">echo</span> <span class="p">(</span><span class="k">new</span> <span class="nx">ImageLoader</span><span class="p">())</span><span class="o">-&gt;</span><span class="na">getResult</span><span class="p">(</span><span class="nv">$_GET</span><span class="p">[</span><span class="s1">'img'</span><span class="p">]);</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-20-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-20-result">
       <div class="apav-result-box">
        <p>This challenge contains a server-side request forgery vulnerability. It allows an attacker to perform requests on behalf of the attacked web server. Thus, servers can be reached that would otherwise be not reachable for an external attacker. For example, this can be abused to perform a port scan and to grab banners (e.g., version of the server) on an internal network that the web server is part of. The exploitable parts are the usage of <code class="inline">file_get_contents()</code> with unfiltered user input in line 14 and the printing of the error message to the user in line 23. An attacker can request an internal URI like <code class="inline">?img=http://internal:22</code> and would get a response such as <code class="inline">failed to open stream: HTTP request failed! SSH-2.0-OpenSSH_7.2p2 Ubuntu-4ubuntu2.2</code> if OpenSSH is running. Information like this can be used to prepare further attacks. Another popular exploit scenario is the retrieval of sensitive AWS credentials when attacking an AWS cloud instance. Besides that, <code class="inline">filter_var()</code> also accepts <code class="inline">file://</code> URLs, enabling an attacker to load local files.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
       ...
       <div class="chroma">
        <table class="lntable">
         <tbody>
          <tr>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="lnt"> 1</span><span class="lnt"> 2</span><span class="lnt"> 3</span><span class="lnt"> 4</span><span class="lnt"> 5</span><span class="lnt"> 6</span><span class="lnt"> 7</span><span class="lnt"> 8</span><span class="lnt"> 9</span><span class="lnt">10</span><span class="lnt">11</span><span class="lnt">12</span><span class="lnt">13</span><span class="lnt">14</span><span class="lnt">15</span><span class="lnt">16</span><span class="lnt">17</span><span class="lnt">18</span><span class="lnt">19</span><span class="lnt">20</span><span class="lnt">21</span><span class="lnt">22</span><span class="lnt">23</span><span class="lnt">24</span><span class="lnt">25</span><span class="lnt">26</span><span class="lnt">27</span><span class="lnt">28</span><span class="lnt">29</span><span class="lnt">30</span><span class="lnt">31</span><span class="lnt">32</span><span class="lnt">33</span></code></pre></td>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">declare</span><span class="p">(</span><span class="nx">strict_types</span><span class="o">=</span><span class="mi">1</span><span class="p">);</span>
...
<span class="k">class</span> <span class="nc">ParamExtractor</span> <span class="p">{</span>
    ...
    <span class="k">private</span> <span class="k">function</span> <span class="o"></span><span class="nf">indices</span><span class="p">(</span><span class="nv">$input</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">public</span> <span class="k">function</span> <span class="o"></span><span class="nf">getCommand</span><span class="p">(</span><span class="nv">$parameters</span><span class="p">)</span> <span class="p">{</span>
...
<span class="nx">system</span><span class="p">(</span><span class="s1">'resizeImg image.png '</span> <span class="o">.</span> <span class="nv">$cmd</span><span class="p">);</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-21-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-21-result">
       <div class="apav-result-box">
        <p>This challenge contains a command injection vulnerability in line 33. The developer declared <code class="inline">strict_types=1</code> in line 1 to ensure the the type hint in the validate function in line 7 throws a <code class="inline">TypeError</code> exception if a non-int is passed to the class. Even with strict types enabled there is an bug with the usage of <code class="inline">array_walk()</code> which ignores the strict typing and uses the default weak typing of PHP instead. An attacker can therefore just append a command to the last parameter that is executed in the system call. A possible payload could look like <code class="inline">?p[1]=1&amp;p[2]=2;%20ls%20-la</code>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
       ...
       <div class="chroma">
        <table class="lntable">
         <tbody>
          <tr>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="lnt"> 1</span><span class="lnt"> 2</span><span class="lnt"> 3</span><span class="lnt"> 4</span><span class="lnt"> 5</span><span class="lnt"> 6</span><span class="lnt"> 7</span><span class="lnt"> 8</span><span class="lnt"> 9</span><span class="lnt">10</span><span class="lnt">11</span><span class="lnt">12</span><span class="lnt">13</span><span class="lnt">14</span><span class="lnt">15</span><span class="lnt">16</span></code></pre></td>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">if</span> <span class="p">(</span><span class="nx">isset</span><span class="p">(</span><span class="nv">$_POST</span><span class="p">[</span><span class="s1">'password'</span><span class="p">]))</span> <span class="p">{</span>
...
<span class="p">}</span></code></pre></td>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-22-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-22-result">
       <div class="apav-result-box">
        <p>The code snippet suffers from 4 vulnerabilities. First, the type-unsafe comparison operator is used in line 12 to compare the hashed password to a string. The string has the form of the scientific notation and as a result it is interpreted as “zero to the power of X”, which is zero. So if we are able to generate a zero-string for the hashed user input as well, the check compares zero to zero and succeeds. This hashes are called “Magic Hashes” and a Google search reveals that the MD5 hash of the value <code class="inline">240610708</code> results in the desired properties. The code snippet calculates the MD5 hash of the password twice though, so it is not possible to directly submit the value. Instead you have to exploit the second vulnerability: the first hash is calculated on the server side but stored in a cookie on the client side. Thus the value <code class="inline">240610708</code> simply has to be directly injected into the password cookie.<br /><br />There are two more vulnerabilities but they are not relevant for this challenge. First, the comparison of the hashes is vulnerable to timing attacks. To prevent this issue, the PHP function <code class="inline">hash_equals()</code> should be used for comparison. Second, the PHP function <code class="inline">md5()</code> is used to hash the password. The MD5 algorithm is considered broken and it was not designed for password hashing. Instead a secure password hashing algorithm like BCrypt should be used. It should be noted that passwords also should not be hard coded but separated into a configuration file.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
  ...
  <div class="modal fade modal-apav" tabindex="-1" role="dialog" id="modal-day-23">
   <div class="modal-dialog" role="document">
        ...
        <table class="lntable">
         <tbody>
          <tr>
           ...
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="k">class</span> <span class="nc">LDAPAuthenticator</span> <span class="p">{</span>
    ...
    <span class="k">function</span> <span class="o"></span><span class="fm">__construct</span><span class="p">(</span><span class="nv">$host</span> <span class="o">=</span> <span class="s2">&quot;localhost&quot;</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">function</span> <span class="o"></span><span class="nf">authenticate</span><span class="p">(</span><span class="nv">$user</span><span class="p">,</span> <span class="nv">$pass</span><span class="p">)</span> <span class="p">{</span>
...
<span class="p">}</span></code></pre></td>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-23-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-23-result">
       <div class="apav-result-box">
        <p>The <code class="inline">LDAPAuthenticator</code> class is prone to an LDAP injection in line 24. By injecting special characters into the username it is possible to alternate the result set of the LDAP query. Although the <code class="inline">ldap_escape()</code> function is used to sanitize the input in lines 19 and 20, a wrong flag has been passed to the sanitize-calls resulting in insufficient/incorrect sanitization. Therefore, in this particular example, the LDAP injection results in an unauthenticated adversary bypassing the authentication mechanism by injecting the asterisk-wildcard <code class="inline">*</code> character as username and password to successfully login as an arbitrary user.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
      ...
      <div class="highlight">
       <div class="chroma">
        <table class="lntable">
         <tbody>
          <tr>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="lnt">1</span><span class="lnt">2</span><span class="lnt">3</span><span class="lnt">4</span><span class="lnt">5</span><span class="lnt">6</span></code></pre></td>
           <td class="lntd"><pre class="chroma"><code class="language-php" data-lang="php"><span class="o">@</span><span class="nv">$GLOBALS</span><span class="o">=</span><span class="nv">$GLOBALS</span><span class="p">{</span><span class="nx">next</span><span class="p">}</span><span class="o">=</span><span class="nx">next</span><span class="p">(</span><span class="nv">$GLOBALS</span><span class="p">{</span><span class="s1">'GLOBALS'</span><span class="p">})</span>
...
<span class="nx">next</span><span class="p">(</span><span class="nx">neXt</span><span class="p">(</span><span class="err">$</span><span class="p">{</span><span class="s1">'next'</span><span class="p">}[</span><span class="s1">'next'</span><span class="p">]));</span></code></pre></td>
          </tr>
         </tbody>
        </table>
       </div>
      ...
      <br />
      <button class="btn btn-border btn-rips-dark" data-toggle="collapse" data-target="#day-24-result"><i class="fa fa-lightbulb-o"></i> &nbsp; Show Solution</button>
      <div class="collapse" id="day-24-result">
       <div class="apav-result-box">
        <p>This challenge consists of a code snippet that was created by one of our team members for the Hack.lu CTF Tournament. It makes heavy use of the <code class="inline">next()</code> function and the <code class="inline">$GLOBALS</code> array. The <code class="inline">next()</code> function moves the internal array pointer up by one. Combined with the <code class="inline">$GLOBALS</code> array this allows us to execute arbitrary code.<br />The payload has to be split up into 2 segments: First, a PHP function to execute, passed in via <code class="inline">$_COOKIE[‘GLOBALS’]</code>. Second, parameters for the injected function, passed in via the file type of a sent file with the same name as the called PHP function. A more detailed write-up of the solution can be found <a href="https://github.com/ctfs/write-ups-2014/tree/master/hack-lu-ctf-2014/next-global-backdoor" target="_blank">here</a>.</p>
       </div>
      </div>
     </div>
     <div class="modal-footer">
  ...
  <div class="footer bg-darkgrey5">
   ...
   <div class="container">
    <div class="row">
     <div class="col-sm-3">
      <a href="/"><img src="https://www.ripstech.com/img/logo_type_light.svg" height="50" alt="RIPS logo" /></a>
      <div class="social">
       <a href="https://twitter.com/ripstech" target="_blank" class="outbound"><i class="fa fa-twitter-square"></i></a> 
       <a href="https://www.linkedin.com/company/rips-technologies" target="_blank" class="outbound"><i class="fa fa-linkedin-square"></i></a> 
       <a href="https://github.com/rips" target="_blank" class="outbound"><i class="fa fa-github-square"></i></a> 
       <a href="https://www.facebook.com/ripstech" target="_blank" class="outbound"><i class="fa fa-facebook-square"></i></a>
      </div>
     </div>
     <div class="col-sm-2">
      <h3>Solution</h3>
      <ul>
       <li><a href="https://www.ripstech.com/use-cases/">Use Cases</a></li>
       <li><a href="https://www.ripstech.com/continuous-integration/">Integration</a></li>
       <li><a href="https://www.ripstech.com/code-review-features/">Features</a></li>
       <li><a href="https://www.ripstech.com/static-code-analysis/">Analysis</a></li>
      </ul>
     </div>
     <div class="col-sm-2">
      <h3>Knowledge</h3>
      <ul>
       <li><a href="https://www.ripstech.com/security-vulnerability-database/">Vulnerability Database</a></li>
       <li><a href="https://www.ripstech.com/php-security-analysis/">Application Security</a></li>
       <li><a href="https://blog.ripstech.com" target="_blank">Research Blog</a></li>
       <li><a href="https://www.ripstech.com/php-security-analysis/#static">Static Code Analysis</a></li>
      </ul>
     </div>
     <div class="col-sm-2">
      <h3>About us</h3>
      <ul>
       <li><a href="https://www.ripstech.com/company/#about">Company</a></li>
       <li><a href="https://www.ripstech.com/careers/">Careers</a></li>
       <li><a href="https://www.ripstech.com/contact/message/">Contact</a></li>
       <li><a href="https://www.ripstech.com/company/">News</a></li>
      </ul>
     </div>
     <div class="col-sm-3">
      <a href="https://www.ripstech.com/request-demo/" class="btn btn-lg btn-border btn-rips-yellow">Request Demo </a>
      <a href="https://www.ripstech.com/contact/message/" class="btn btn-lg btn-border btn-rips-white">&nbsp;&nbsp;&nbsp;&nbsp;Contact Us</a>
     </div>
    </div>
   </div>
  </div>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/parallax.js/1.4.2/parallax.min.js" integrity="sha384-191lGeNFb/opBtMPR6fciFYFRiN1uXakwsn4wTer3VvZ5IEUo0f6I/g1vkkL44vX" crossorigin="anonymous"></script>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/8.5.2/js/intlTelInput.min.js" integrity="sha384-/MlYS8/RBGdgsmNJxvx9bOOjQgZ+Zf4sPTwaEm3CkKGCS/agL3O4NXkfbbQKAKUB" crossorigin="anonymous"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/8.5.2/js/utils.js" integrity="sha384-mTHZo+1xiObawuGzjDrnhW5AqcMpslIOkyHFePVzVcySgmDbje2YqF1QsppBivQG" crossorigin="anonymous"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/js-cookie/2.1.2/js.cookie.min.js" integrity="sha384-njx5FgqpVYve6PBlKzM7DW2JiqYOxANSYX9FlIXT5veknIsRUDKOwRs8IrMKfvsj" crossorigin="anonymous"></script>
  <script>
  $(document).ready(function(){
      $(".day").click(function () {
      	   var target = $(this).children(".door").attr("data-target");
      	   var day = target.replace(/#modal-day-/, "");
      	   var to = "/day"+day+".php";
      	   window.open(to);
      	   return false;
      });
